...
% To identify the most crucial reactions within a genome-scale model, one can 
% leverage precomputed sampling data. This process involves three key steps included 
% in the |identifySignificantRxns| function:
%% 
% * *Sampling the Flux Space:* Initiate the analysis by sampling the flux space.
% * *Calculating the Covariance Matrix:* Compute the covariance matrix based 
% on the sampled data.
% * *Computing the Euclidean Norm:* Determine the Euclidean norm to quantify 
% the significance of reactions. 
%% 
% These steps facilitate the identification of reactions for which constraining 
% their bounds would have a substantial impact on the original flux space.
% 
% This approach was initially proposed in the work of _Preciat et al._${\;}^5$ 
% to determine which reactions should be measured exometabolically for maximizing 
...
%% 
% Acetate has been identified as the most significant reaction. Now, let's reduce 
% acetate production in the model by half to observe its impact on the flux space.
...
ylabel('# samples')
%% 
% When modifying the oxygen exchange (|EX_o2(e)|) bounds from -1000 to 1000 
% to a more constrained range of -17 to 1000, an associated alteration is observed 
% in the acetate exchange (|EX_ac(e)|) based on the identified significant reactions, 
% shifting from the range of 0 to 1000 to a range of 0 to 500. Consequently, this 
% adjustment impacts the distribution of fluxes related to half acetate production, 
% influencing biomass production in a comparable manner.
%% References
%% 
% # Orth, J. D., Thiele I., and Palsson, B. Ø. What is flux balance analysis? 
% _Nat. Biotechnol._ 28(3), 245-248 (2010).
% # Haraldsdóttir, H. S., Cousins, B., Thiele, I., Fleming, R.M.T., and Vempala, 
...
% # Zhang, Y. and Gao, L. On Numerical Solution of the Maximum Volume Ellipsoid 
% Problem. _SIAM J. Optimiz_. 14(1), 53-76 (2001).
% # Berbee, H. C. P., Boender, C. G. E., Rinnooy Ran, A. H. G., Scheffer, C. 
...
% # Preciat G., Lucumi Moreno E., Wegrzyn A.B., Willacey C.C.W., Modamio J., 
% Monteiro F.L., El Assal D., Schurink A., Oliveira M.A.P., Zhang Z., Cousins 
% B., Haraldsdóttir H.S., Zach S., Vempala S., Hengerer B., Saunders M.A., Harms 
% A., Schwamborn J.C., Thiele I., Hankemeier T., Fleming R.M.T.. Mechanistic model-driven 
