...
projectDir = strrep(which('CDG_tutorial.mlx'),['notebooks' filesep 'CDG_tutorial.mlx'], '');
...
inputData = [dataDir filesep 'metaboliteIds.xlsx'];
[model, hasEffect] = addMetInfoInCBmodel(model, inputData, false);
